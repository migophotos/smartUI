...
const vocEn = [
    ...
    ["Справа Выше", "Right Up"],
    ["Справа По верху", "Right Top"],
    ["Справа Ниже", "Right Down"],

    ["Слева Выше", "Left Up"],
    ["Слева По верху", "Left Top"],
    ["Слева Ниже", "Left Bottom"],

    ["По центру Выше", "Center Up"],
    ["По центру Ниже", "Center Down"],
    ...
    ["Просто подсказка", "Just a tooltip" ],
    ["Круговая диаграмма", "Flat pie diagramm"],
    ["Картинка!", "External Image"],
    ["Ссылка на ресурс", "External URL"],
